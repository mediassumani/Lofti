...
class HomePageViewController: UITableViewController {
    ...
    fileprivate func createDummyData(){
        ...
        spaces.append(Space("Willow Waffle", "Clean space for small study group","03:00PM - 5:00PM",  UIImage(named: "MakeSchoolLogo")!, "555 Post ST", "Make School", 4, true, 9.0))
        
        spaces.append(Space("Tea Tree Torte", "Cozy small place to work", "07:00PM - 8:00PM", UIImage(named: "MakeSchoolLogo")!, "555 Post ST", "Make School", 3, true, 7.50))
        
        spaces.append(Space("Manzanita Macaroon", "Small tidy place to work", "09:00AM - 5:00PM", UIImage(named: "MakeSchoolLogo")!, "555 Post ST", "Make School", 3, true, 7.50))
    }
}
